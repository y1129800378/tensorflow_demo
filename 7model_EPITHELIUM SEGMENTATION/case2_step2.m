clc
clear
load /home/yyy/Desktop/case2_epi/patients_patches.mat %load up the patch struct we previously created
...
for zz=1:nfolds %open all of the file Ids for the training and testing files
    ...
    fidtrain(zz)=fopen(sprintf('/home/yyy/Desktop/case2_epi/train_data_package/train_w32_%d.txt',zz),'w');
    fidtest(zz)=fopen(sprintf('/home/yyy/Desktop/case2_epi/train_data_package/test_w32_%d.txt',zz),'w');
    
    fidtrain_parent(zz)=fopen(sprintf('/home/yyy/Desktop/case2_epi/train_data_package/train_w32_parent_%d.txt',zz),'w');
    fidtest_parent(zz)=fopen(sprintf('/home/yyy/Desktop/case2_epi/train_data_package/test_w32_parent_%d.txt',zz),'w');
end
