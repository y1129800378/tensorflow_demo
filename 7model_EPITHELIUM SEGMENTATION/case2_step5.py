...
caffe_root = '/usr/local/caffe-caffe-0.15/'
...
MODEL_FILE = '/home/yyy/Desktop/case2_epi/bin_data_save/deploy_train32.prototxt' 
PRETRAINED = '/home/yyy/Desktop/case2_epi/bin_data_save/1_caffenet_train_w32_iter_600000.caffemodel' 
IMAGE_DIR= '/home/yyy/Desktop/case2_epi/train_data/' 
OUTPUT_DIR= '/home/yyy/Desktop/case2_epi/output/'
...
file = open('/home/yyy/Desktop/case2_epi/bin_data_save/DB_train_w32_1.binaryproto','rb')
data = file.read()
...
files=open('/home/yyy/Desktop/case2_epi/train_data_package/test_w32_parent_1.txt','rb')
...
for base_fname in files:
	...
	for fname in sorted(glob.glob("%s*"%(base_fname))): #get all of the files which start with this patient ID
		print fname
		...
		image = caffe.io.load_image('/home/yyy/Desktop/case2_epi/train_data/'+fname) #load our image
