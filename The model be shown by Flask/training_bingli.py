...
N_CLASSES = 3
IMG_W = 36  # resize the image, if the input image is too large, training will be very slow.
IMG_H = 36
BATCH_SIZE = 16
CAPACITY = 2000
MAX_STEP = 1200000 # with current parameters, it is suggested to use MAX_STEP>10k
...
def run_training():
    ...
    train_dir = '/home/yyy/subs_tf'
    logs_train_dir = '/home/yyy/Downloads/save_data2'
...
#     
#     # you need to change the directories to yours.
#     train_dir ='C:/Users/yinyy/Desktop/Kaggle_cat_vs_dog_540M/train'
#     train, train_label = input_data.get_files(train_dir)
...
#         
#         # you need to change the directories to yours.
#         logs_train_dir = 'C:/Users/yinyy/Desktop/Kaggle_cat_vs_dog_540M/data_save' 
#                        
#         saver = tf.train.Saver()
#         
