...
outdir='/home/yyy/Desktop/case2_epi/subs/';
mkdir(strrep(outdir,'..','.'));
wsize=32;
hwsize=wsize/2;
...
ratio_dilation = 1; 
ratio_background=.3;
files=dir('/home/yyy/Desktop/case2_epi/train_data/masks/*_mask.png');
...
for ci=1:length(patients)
    ...
    files=dir(sprintf('/home/yyy/Desktop/case2_epi/train_data/%s_*.tif',patients{ci}));
    ...
    for fi=1:length(files)
        ...
        try
            read_data=['/home/yyy/Desktop/case2_epi/train_data/',fname]
            io=imread(read_data);
            read_mask=['/home/yyy/Desktop/case2_epi/train_data/masks/',fname_mask]
            io_mask=imread(read_mask);
...
save('/home/yyy/Desktop/case2_epi/train_data/patients_patches.mat','patient_struct')